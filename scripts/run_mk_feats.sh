...
#python ./main.py  model=LGBM_feat=lgbmBest_categoricalThreVal=10000_validation=subm_params=-,gbdt,0.45,0.04,188,7,auc,20,5,0,20,76,binary,0,0,32.0,1.0,200000,1,0 > /tmp/lgbm.log 2>&1; grep "validation auc:" /tmp/lgbm.log
