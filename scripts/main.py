import pandas as pd
import scripts.model_lib
from scripts.lib_util import get_target, get_opt
from scripts.read_data import read_data_ph1, read_csv
...
auc = scripts.model_lib.Predict(train_df, val_df, test_df, predictors, categorical, seed=get_opt('seed',2018))
